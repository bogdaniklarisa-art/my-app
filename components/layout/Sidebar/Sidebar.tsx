...
const customerLinks = [
  ...
  { label: "Decision Models", href: "/decision-models", icon: "decision" },
...
const businessLinks = [
  ...
  { label: "Loan Products", href: "/loan-products", icon: "loan-products" },
  { label: "Savings Products", href: "/savings-products", icon: "savings-products" },
  { label: "Fees and Charges", href: "/fees-charges", icon: "fees" },
  { label: "Transactions", href: "/transactions", icon: "transactions" },
  { label: "Services", href: "/services", icon: "services" },
  { label: "Service Account", href: "/service-account", icon: "service-account" },
...
const settingsLinks = [
  ...
  { label: "Fees and Pricing", href: "/fees-pricing", icon: "fees-pricing" },
...
function NavIcon({ name }: { name: string }) {
  ...
  return <span className={styles.icon}>{icons[name] ?? icons.users}</span>;
}
      ...
      <aside className={`${styles.sidebar} ${open ? styles.open : ""}`} aria-label="Main navigation">
        <Link href="/users" className={styles.logo} onClick={onClose}>
          <svg width="144" height="30" viewBox="0 0 144 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M8 8h6v14H8V8zm8 0h6v14h-6V8z" fill="white" opacity="0.9" />
            <text x="38" y="21" fontFamily="Work Sans, sans-serif" fontWeight="700" fontSize="16" fill="#213F7D">lendsqr</text>
          </svg>
        </Link>
